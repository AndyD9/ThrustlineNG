...
| KI-020 | High | Desktop / Stability | Le binaire Tauri Release est sorti avec `-1073740791` dans la session d'exécution Codex avant une mesure à 60 s ; la cause produit ou environnement n'est pas tranchée. | Campagne T0015 du 29 juillet 2026 ; builds et tests automatisés verts, campagne GUI non concluante | Vérification T0015 dans une session Windows interactive | Open |
