...
| KI-021 | High | Backend / Privacy | T0018 résout la FK `on delete restrict` par un workflow local/CI transactionnel d'export et suppression, mais aucune sauvegarde managée, restauration isolée ni replay post-restauration n'existe encore. | PostgreSQL 17 CI : 4 fichiers/70 assertions, deux resets, concurrence et types stables le 31 juillet 2026 ; admission réelle toujours bloquée | Sauvegarde/restauration et replay avant données réelles | Open |
