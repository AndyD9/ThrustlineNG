...
| KI-022 | Medium | Governance / Quality | Le gate de maintenance est livré, mais son auto-test utilise KI-022 comme fixture active et empêche de résoudre proprement cette entrée. | T0033 : passer KI-022 à `Resolved` fait échouer l'auto-test « tracked governance debt » de `tests/maintenance/run.ps1`; le gate repasse lorsque l'entrée reste active | T0034 — découpler la fixture du statut réel | Scheduled |
