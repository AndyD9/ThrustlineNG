...
| KI-021 | High | Backend / Privacy | T0018 couvre export/suppression et T0019 couvre restauration/replay synthétiques en CI, mais aucune sauvegarde managée/chiffrée, purge du journal pseudonyme, restauration Vault/Storage ou promotion de production n'existe. | Run PostgreSQL 17 `30621209180` : 6 fichiers/105 assertions, deux resets, concurrence, types, dump/restore/replay isolé et nettoyage réussis ; aucune donnée réelle | Sauvegarde managée, purge et exercice de production avant données réelles | Open |
