...
| KI-022 | Medium | Governance / Quality | Le registre de maintenance, les statuts ticket/index et les marqueurs de dette dans le code ne disposent pas d'un contrôle automatisé commun. | T0025–T0028 ont nécessité des réconciliations documentaires ou de livraison ; `tests/` ne contient aucun harnais dédié à `KNOWN_ISSUES.md` | T0030 | Scheduled |
