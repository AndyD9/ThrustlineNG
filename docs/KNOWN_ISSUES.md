...
| KI-018 | High | Frontend / Security | `react-router` 7.18.1 est concerné par `GHSA-qwww-vcr4-c8h2` ; le gate pnpm T0013 échoue comme prévu. | T0016 épingle 8.3.0 ; audit local du 29 juillet 2026 sans vulnérabilité connue, CI GitHub encore à observer | T0016 | Scheduled |
