...
| T0018 | Exporter puis supprimer un compte sans perte ni double opération | 2 | T0012, T0017, revue phase 1 | In progress |
...
5 minutes au plus et un export récupérable pendant le délai. Le ticket est
`In progress` sur `security/T0018-account-lifecycle`.
