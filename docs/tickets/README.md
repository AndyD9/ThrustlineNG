...
Les implémentations T0006 à T0009 sont présentes dans `main` et leurs validations
automatisées sont vertes au 28 juillet 2026. Elles restent `Verify` jusqu'aux
contrôles humains précisément consignés dans chaque ticket. T0010 est le prochain
ticket technique recommandé : il reliera le shell et le bridge par un contrat
local authentifié.
