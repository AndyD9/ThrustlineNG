...
- **F0002** (`Blocked`) — clôture et encaissement depuis l'application
  (option C : le temps de bloc vient du résumé mesuré). Ses trois jalons sont
  implémentés sur la PR #131, en brouillon sur sa propre branche : elle attend
  la fusion de F0006 pour y brancher la clôture (décision d'Andy du
  7 août 2026, KI-028).
...
1. F0006 — le rattachement mesure ↔ vol et le réarmement entre deux vols,
   prérequis de F0002 (KI-028, « go 1 » du 7 août 2026).
2. F0002 — la clôture depuis l'application (PR #131 en brouillon), branchée
   sur F0006 après sa fusion.
